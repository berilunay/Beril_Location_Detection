...
def train_part():
    ...
    hparams = {'weight_decay': 0.00015580008840493994,
               'batch_size': 3,
               'learning_rate': 4.051572326186531e-04,
               'num_workers': 3,
               'gpus': 1,
               'test': 1
               }
    ...
    trainer = pytorch_lightning.Trainer(max_epochs=20, gpus=hparams['gpus'], logger=WandbLogger(),
                                        callbacks=Datasetview(), log_every_n_steps=5)
